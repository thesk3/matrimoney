myApp.factory('AuthenticationService',
    ...
    function (Base64, $http, $cookieStore, $rootScope, $timeout) {
		...
		var userHasPermissionForView = function(view) {
			...
			return service
					.userHasPermission(view.permissions);
		};
			...
			angular
					.forEach(
							...
							function(permission, index) {
								console
										.log($rootScope.globals.currentUser.permissions);
								if ($rootScope.globals.currentUser.permissions
		...
		service.Login = function(username, password,
			...
			console.log("username-->",username);
			 ...
			 success : username === 'admin@gmail.com' && password === 'test'  
